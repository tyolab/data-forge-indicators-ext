...
function rs_update<IndexT = any>(this: IDataFrame<IndexT, number>, comparative: ISeries<IndexT, number>, length: number, key: string, valueKey: string): IDataFrame<IndexT, number> {
